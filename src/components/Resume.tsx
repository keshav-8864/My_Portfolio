...
export function Resume() {
  return (
    <section id="resume" className="py-16 md:py-32 bg-[var(--background)] relative">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        <div className="flex flex-col md:flex-row gap-10 md:gap-20">
          ...
          <div className="md:w-1/3">
            <div className="md:sticky md:top-32">
              <motion.p 
                ...
                viewport={{ once: true }}
                className="text-xs sm:text-sm font-bold uppercase tracking-[0.2em] text-[var(--foreground)]/60 mb-3 sm:mb-4"
              >
                Journey
              </motion.p>
              ...
              <motion.h2 
                ...
                className="text-3xl sm:text-4xl md:text-5xl font-bold text-[var(--foreground)] leading-tight mb-4 sm:mb-6"
              >
                My <br />
              ...
              <motion.p 
                ...
                className="text-[var(--foreground)]/70 text-base md:text-lg leading-relaxed mb-8"
              >
              ...
              <motion.a
                ...
                className="inline-flex items-center justify-center px-6 py-3 border border-[var(--border)] rounded-lg text-[var(--foreground)] font-medium hover:bg-[var(--card)] hover:border-[var(--primary)]/50 transition-all duration-300 w-full sm:w-auto"
              >
                View Full Resume
              </motion.a>
            </div>
          ...
          <div className="md:w-2/3 mt-8 md:mt-0">
            <div className="relative border-l-2 border-[var(--primary)]/30 ml-2 md:ml-0 pl-6 md:pl-10 pb-4">
              {resumeData.map((item, index) => (
                ...
                >
                  {/* Timeline Dot */}
                  <div className="absolute w-4 h-4 rounded-full bg-[var(--primary)] border-4 border-[var(--background)] -left-[33px] md:-left-[49px] top-1.5 shadow-[0_0_10px_var(--primary)] z-10" />
